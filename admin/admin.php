...
$query="SELECT *from student_data where school='$school'";
$count=mysqli_query($con,$query);
$total=array();
while ($row = mysqli_fetch_assoc($count)) {
  $total[] = $row['description'];
}
$query1 = "SELECT *from student_data where description='Financial Problems' and school like '$school'";
$query2 = "SELECT *from student_data where description='Domestic Work' and school like '$school'";
$query3 = "SELECT *from student_data where description='Lack of interest in education' and school like '$school'";
$query4 = "SELECT *from student_data where description='Inadequate teaching staff' and school like '$school'";
$query5 = "SELECT *from student_data where description='Overloaded with course works' and school like '$school'";
$query6 = "SELECT *from student_data where description='Others' and school like '$school'";
    ...
    <div>
      <p>
        <div class="main" style="height:100%; width:100%;"><br>
          <div id="piechart"></div><br><br><br>
          <p><b>Total Students Dropped From This School : <?php echo count(array_filter($total));?></b></p></div>
